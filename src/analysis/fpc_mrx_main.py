...
import src.analysis.vel_proc as vel
import src.analysis.vdf_proc as vdf
import src.analysis.evec_proc as evec
import src.analysis.fpc_proc as fpc
import src.utils.helper_utils as hutil
import src.utils.coord_utils as coord
import src.utils.io_utils as iout
...
def fpc_mrx_main(trange, species='e', vth_lim=3.5, bin_width_frac=0.1, mean_phi=True, 
    ...
    vbin, grids_corr, interleave_check = vel.nrgy_to_vbin('nrgy', 'scpot_dwn', species='e')
    ...
    # --- Lorentz Transform Electric Field ---
    ...
    dat_grps = {
        ...
        "fac": {
            "vdf_vol":       bvdf_vol_fac,
            "npts_vol":      npts_vol_fac,
            "vdf_avg":       bvdf_avg_fac,
            "Cprime_avg":    bcpfac_avg,
            "Cprime_vol":    bcpfac_vol,
        ...
        "lmn": {
            "vdf_vol":       bvdf_vol_lmn,
            "npts_vol":      npts_vol_lmn,
            "vdf_avg":       bvdf_avg_lmn,
            "Cprime_avg":    bcplmn_avg,
            "Cprime_vol":    bcplmn_vol,
